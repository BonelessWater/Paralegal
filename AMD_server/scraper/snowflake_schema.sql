...
-- ============================================================================
-- IMPORTANT: Before running this script in Snowflake Web UI
-- ============================================================================
-- 1. Log into https://app.snowflake.com/
-- 2. Click "Worksheets" → "+ Worksheet"
-- 3. In the TOP RIGHT, select Warehouse: COMPUTE_WH (or any existing warehouse)
-- 4. Paste this entire script and click "Run All"
-- ============================================================================
...
-- Note: Warehouse, database, and schema are already created and set above
-- No need to USE them again here - context is preserved in the session
